...
@section('content')
    <div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
        <h2 class="text-3xl font-bold mb-6 text-blue-600">Edit Employee</h2>
        ...
        <form action="{{ route('employees.update', $employee->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4 relative">
                ...
                <input type="text" id="dob" name="dob" placeholder="Select Date of Birth"
                    class="pl-10 pr-10 px-4 py-3 border rounded-md focus:outline-none focus:ring focus:ring-blue-300
